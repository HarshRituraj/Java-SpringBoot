...
public class MyExceptionAdvisor extends ResponseEntityExceptionHandler
{
	...
	public ResponseEntity<ErrorResponse> handleExceptionAadhaarNotFoundException(AadhaarNotFoundException e, HttpServletRequest request)
	{
	...
	public ResponseEntity<ErrorResponse> handleExceptionTokenExpireException(TokenExpireException e, HttpServletRequest request)
	{
		ErrorResponse response = new ErrorResponse();
		response.setCode(404);
		response.setMessage(e.getMessage());
